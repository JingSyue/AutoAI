...
bg_img = bg_img.resize((root.winfo_screenwidth(), root.winfo_screenheight()), Image.ANTIALIAS)
...
note_label = ttk.Label(frame, text="Note: player number should be at least 2 players",font=("Helvetica", 10, "bold"))
